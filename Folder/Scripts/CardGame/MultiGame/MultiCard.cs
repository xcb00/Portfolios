...
public class MultiCard : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void Initialise(int num, int index, Action dropCard, float adjust)
    {
